...
export class SharedService {
  ...
  /* SVG'S */
  thumbsDown: string = `<svg xmlns="http://www.w3.org/2000/svg"
  ...
  fatSingle: string = `<svg id="" data-name="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28.44 50.31" width="6rem" height="4rem" class="">
  <defs>
    <style>
      .cls-fatSingle {
        fill: none;
  ...
  <g id="">
    <g>
      <path class="cls-fatSingle" d="M7.09,14.66c-.95,1.66-3.39,10.52-1.33,13.37-.76,1.92,.11,5.92,1.67,13.16,.5,2.33,.97,4.53,1.21,6.18,.19,1.32,1.29,2.28,2.63,2.28,1.49,0,2.73-1.21,2.75-2.71l-.22-16.98c0-.36-.01-.65,.36-.65,.33,0,.33,.25,.33,.65l-.22,16.98c.03,1.49,1.26,2.71,2.75,2.71,1.34,0,2.37-.97,2.63-2.28,1.79-8.88,4.36-15.16,2.87-19.35,2.07-2.86-.38-11.71-1.33-13.37"/>
      <path class="cls-fatSingle" d="M13.88,9.41c-2.42,0-3.54-2.39-3.58-4.76-.04-2.5,1.24-3.99,3.43-3.99s3.53,1.49,3.57,3.99c.04,2.37-1,4.76-3.41,4.76Z"/>
      <g>
        <path class="cls-fatSingle" d="M24.24,27.98c.1,1.04,.19,2.27,1.77,2.23,1.46-.04,1.77-.91,1.77-1.67-.04-5.64-1.07-9.31-2.24-12.43-1.17-3.13-3.26-4.94-5.75-5.94-.92-.37-2.77-.84-4.1-.97"/>
        <path class="cls-fatSingle" d="M4.2,27.98c-.1,1.04-.19,2.27-1.77,2.23-1.46-.04-1.77-.91-1.77-1.67,.04-5.64,.92-9.31,2.09-12.43,1.17-3.13,3.26-4.94,5.75-5.94,.41-.16,1.02-.35,1.67-.52"/>
      </g>
    </g>
  </g>
  </svg>`;
  fatDouble: string = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 185.02 145">
  <defs>
    <style>
      .cls-111 {
        isolation: isolate;
        ...
        <g>
          <g>
            <g>
              <path
                class="cls-222"
                d="M15.22,48.5c-2.17,3.8-7.75,24.04-3.03,30.57-1.73,4.38,.26,13.54,3.81,30.09,1.14,5.33,2.22,10.37,2.76,14.13,.43,3.02,2.96,5.2,6.01,5.2,3.41,0,6.23-2.78,6.29-6.19l-.51-38.8c0-.83-.03-1.49,.83-1.48,.76,.01,.76,.57,.76,1.48l-.51,38.8c.06,3.41,2.88,6.19,6.29,6.19,3.06,0,5.41-2.22,6.01-5.2,4.09-20.31,9.97-34.66,6.57-44.23,4.72-6.54-.86-26.77-3.03-30.57"
              />
              <path
                class="cls-222"
                d="M30.72,36.5c-5.52,0-8.09-5.47-8.19-10.89-.1-5.71,2.83-9.11,7.84-9.11s8.06,3.41,8.16,9.11c.1,5.42-2.28,10.89-7.81,10.89Z"
              />
              <g>
                <path
                  class="cls-222"
                  d="M54.41,78.96c.22,2.38,.44,5.19,4.05,5.11,3.34-.08,4.05-2.07,4.04-3.81-.09-12.9-2.45-21.27-5.12-28.41-2.67-7.15-7.45-11.29-13.15-13.57-2.1-.84-6.34-1.91-9.36-2.21"
                />
                <path
                  class="cls-222"
                  d="M8.59,78.96c-.22,2.38-.44,5.19-4.05,5.11-3.34-.08-4.05-2.07-4.04-3.81,.09-12.9,2.11-21.27,4.78-28.41s7.45-11.29,13.15-13.57c.94-.38,2.32-.8,3.83-1.18"
                />
              </g>
            </g>
            <g>
              <path
                class="cls-222"
                d="M42.65,45.07c-2.48,4.34-8.86,27.47-3.46,34.94-1.98,5,.3,15.48,4.35,34.39,1.31,6.09,2.54,11.85,3.15,16.15,.49,3.45,3.38,5.95,6.87,5.95,3.9,0,7.12-3.17,7.19-7.07l-.58-44.35c-.01-.95-.03-1.71,.95-1.69,.87,.01,.87,.65,.87,1.69l-.58,44.35c.07,3.9,3.29,7.07,7.19,7.07,3.49,0,6.18-2.54,6.87-5.95,4.67-23.21,11.39-39.61,7.5-50.54,5.4-7.47-.98-30.6-3.46-34.94"
              />
              <path
                class="cls-222"
                d="M60.37,31.36c-6.31,0-9.25-6.25-9.36-12.44-.12-6.52,3.23-10.41,8.96-10.41s9.21,3.89,9.32,10.41c.11,6.2-2.61,12.44-8.92,12.44Z"
              />
              <g>
                <path
                  class="cls-222"
                  d="M87.45,79.89c.26,2.72,.5,5.94,4.63,5.84,3.82-.09,4.63-2.37,4.62-4.35-.1-14.74-2.8-24.31-5.85-32.47-3.06-8.17-8.52-12.91-15.03-15.51-2.4-.96-7.24-2.18-10.7-2.53"
                />
                <path
                  class="cls-222"
                  d="M35.08,79.89c-.26,2.72-.5,5.94-4.63,5.84-3.82-.09-4.63-2.37-4.62-4.35,.1-14.74,2.41-24.31,5.47-32.47,3.06-8.17,8.52-12.91,15.03-15.51,1.08-.43,2.65-.92,4.37-1.35"
                />
              </g>
            </g>
            <g>
              <path
                class="cls-222"
                d="M105.15,45.07c-2.48,4.34-8.86,27.47-3.46,34.94-1.98,5,.3,15.48,4.35,34.39,1.31,6.09,2.54,11.85,3.15,16.15,.49,3.45,3.38,5.95,6.87,5.95,3.9,0,7.12-3.17,7.19-7.07l-.58-44.35c-.01-.95-.03-1.71,.95-1.69,.87,.01,.87,.65,.87,1.69l-.58,44.35c.07,3.9,3.29,7.07,7.19,7.07,3.49,0,6.18-2.54,6.87-5.95,4.67-23.21,11.39-39.61,7.5-50.54,5.4-7.47-.98-30.6-3.46-34.94"
              />
              <path
                class="cls-222"
                d="M122.86,31.36c-6.31,0-9.25-6.25-9.36-12.44-.12-6.52,3.23-10.41,8.96-10.41s9.21,3.89,9.32,10.41c.11,6.2-2.61,12.44-8.92,12.44Z"
              />
              <g>
                <path
                  class="cls-222"
                  d="M149.94,79.89c.26,2.72,.5,5.94,4.63,5.84,3.82-.09,4.63-2.37,4.62-4.35-.1-14.74-2.8-24.31-5.85-32.47-3.06-8.17-8.52-12.91-15.03-15.51-2.4-.96-7.24-2.18-10.7-2.53"
                />
                <path
                  class="cls-222"
                  d="M97.58,79.89c-.26,2.72-.5,5.94-4.63,5.84-3.82-.09-4.63-2.37-4.62-4.35,.1-14.74,2.41-24.31,5.47-32.47,3.06-8.17,8.52-12.91,15.03-15.51,1.08-.43,2.65-.92,4.37-1.35"
                />
              </g>
            </g>
            <g>
              <path
                class="cls-222"
                d="M137.24,48.5c-2.17,3.8-7.75,24.04-3.03,30.57-1.73,4.38,.26,13.54,3.81,30.09,1.14,5.33,2.22,10.37,2.76,14.13,.43,3.02,2.96,5.2,6.01,5.2,3.41,0,6.23-2.78,6.29-6.19l-.51-38.8c0-.83-.03-1.49,.83-1.48,.76,.01,.76,.57,.76,1.48l-.51,38.8c.06,3.41,2.88,6.19,6.29,6.19,3.06,0,5.41-2.22,6.01-5.2,4.09-20.31,9.97-34.66,6.57-44.23,4.72-6.54-.86-26.77-3.03-30.57"
              />
              <path
                class="cls-222"
                d="M152.74,36.5c-5.52,0-8.09-5.47-8.19-10.89-.1-5.71,2.83-9.11,7.84-9.11s8.06,3.41,8.16,9.11c.1,5.42-2.28,10.89-7.81,10.89Z"
              />
              <g>
                <path
                  class="cls-222"
                  d="M176.43,78.96c.22,2.38,.44,5.19,4.05,5.11,3.34-.08,4.05-2.07,4.04-3.81-.09-12.9-2.45-21.27-5.12-28.41-2.67-7.15-7.45-11.29-13.15-13.57-2.1-.84-6.34-1.91-9.36-2.21"
                />
                <path
                  class="cls-222"
                  d="M130.61,78.96c-.22,2.38-.44,5.19-4.05,5.11-3.34-.08-4.05-2.07-4.04-3.81,.09-12.9,2.11-21.27,4.78-28.41,2.67-7.15,7.45-11.29,13.15-13.57,.94-.38,2.32-.8,3.83-1.18"
                />
              </g>
            </g>
          </g>
          <g class="cls-555">
            ...
            <path
              class="cls-444"
              d="M94.07,26.21c-7.1,0-10.41-7.03-10.53-14-.13-7.34,3.64-11.71,10.08-11.71s10.36,4.38,10.49,11.71c.12,6.97-2.93,14-10.04,14Z"
            />
            <path
              class="cls-444"
              d="M62.69,63.18c-1.38,7.77-1.43,17.64-1.43,17.64-.32,3.06-.64,6.68-5.88,6.56-4.85-.1-5.88-2.67-5.86-4.89,.13-16.58,3.06-27.35,6.94-36.53,3.88-9.19,10.82-14.52,19.09-17.44,1.37-.48,3.37-1.03,5.55-1.52,3.47-.79,12.73-1.62,18.31-1.32,4.4,.24,10.54,1.77,13.59,2.84,8.27,2.93,15.21,8.25,19.09,17.44,3.88,9.18,7.31,19.95,7.43,36.53,.02,2.23-1.01,4.79-5.86,4.89-5.24,.11-5.56-3.5-5.88-6.56,0,0-.82-11.01-1.74-16.87"
            />
          </g>
          <g>
            <path
              class="cls-333"
              d="M64.48,41.64c-2.81,4.88-10.04,30.9-3.92,39.31-2.25,5.63,5.28,17.41,9.87,38.69,1.48,6.85,2.88,13.33,3.57,18.17,.55,3.88,3.83,6.69,7.79,6.69,4.42,0,8.07-3.57,8.15-7.96l-.66-49.89c-.01-1.07-.03-1.92,1.08-1.9,.98,.01,.99,.73,.99,1.9l-.66,49.89c.08,4.39,3.73,7.96,8.15,7.96,3.96,0,7.01-2.85,7.79-6.69,5.29-26.11,17.85-44.56,13.44-56.86,6.12-8.4-1.11-34.42-3.92-39.31"
            />
            <path
              class="cls-333"
              d="M90.07,26.21c-7.1,0-10.41-7.03-10.53-14-.13-7.34,3.64-11.71,10.08-11.71s10.36,4.38,10.49,11.71c.12,6.97-2.93,14-10.04,14Z"
            />
            <g>
              <path
                class="cls-333"
                d="M123.77,80.83c.32,3.06,.64,6.68,5.88,6.56,4.85-.1,5.88-2.67,5.86-4.89-.13-16.58-3.55-27.35-7.43-36.53-3.88-9.19-10.82-14.52-19.09-17.44-3.05-1.08-9.2-2.46-13.59-2.84"
              />
              <path
                class="cls-333"
                d="M57.26,80.83c-.32,3.06-.64,6.68-5.88,6.56-4.85-.1-5.88-2.67-5.86-4.89,.13-16.58,3.06-27.35,6.94-36.53,3.88-9.19,10.82-14.52,19.09-17.44,1.37-.48,3.37-1.03,5.55-1.52"
              />
            </g>
          </g>
        </g>
  ...
  arrowRight: string = `<svg
  xmlns="http://www.w3.org/2000/svg"
  height="3rem"
  viewBox="0 -960 960 960"
  width="3rem"
  fill=""
  class="bef bef-d-flex bef-h-100per bef-opacity-0_5 bef-ms-2rem bef-me-1rem"
>
  <path
    d="m560-240-56-58 142-142H160v-80h486L504-662l56-58 240 240-240 240Z"
  />
</svg>`;
  whiteArrowRight: string = `<svg
xmlns="http://www.w3.org/2000/svg"
height="24px"
viewBox="0 -960 960 960"
width="24px"
...
>
  ...
  apple: string = `<svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50.2 56">
  <g id="CONTENT">
    <g>
  ...
  bascula: string = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 160 204.97">
  <defs>
    <style>
      .cls-1 {
        fill: #e8563f;
  ...
  drop: string = `<svg id="" data-name="" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 27.55 42" width="5rem" height="4rem">
  <defs>
    <style>
      .cls-drop {
  ...
  estetoscopio: string = `<svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 49.88 56">
  <g id="CONTENT">
    <g>
  ...
  heart: string = `<svg id="" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 78.9 71.84" width="5rem" height="3rem">
  <defs>
    <style>
      .cls-heart {
        fill: none;
  ...
  <g id="CONTENT">
    <path class="cls-heart" d="M6.53,37.33C.75,27.43-1.12,16.88,7.15,8.14,11.29,3.75,16.72,1.56,22.15,1.56c18.09,0,14.97,12.99,17.3,15.47,2.33-2.48-.79-15.47,17.3-15.47,5.43,0,10.86,2.19,15,6.58,20.18,21.36-20.04,53.42-30.1,60.71-2.73,1.98-1.8,1.9-4.65-.18-3.85-2.8-11.62-8.87-18.9-16.48"/>
    <path class="cls-heart" d="M3.54,44h14.48l4.31-27.21,4.99,27.21h7.02l4.31,12.89c3.93-11.08,6.52-18.15,9.86-30.08l4.8,17.19h14.4"/>
    <path class="cls-heart" d="M6.53,37.33C.75,27.43-1.12,16.88,7.15,8.14,11.29,3.75,16.72,1.56,22.15,1.56c18.09,0,14.97,12.99,17.3,15.47,2.33-2.48-.79-15.47,17.3-15.47,5.43,0,10.86,2.19,15,6.58,20.18,21.36-20.04,53.42-30.1,60.71-2.73,1.98-1.8,1.9-4.65-.18-3.85-2.8-11.62-8.87-18.9-16.48"/>
    <path class="cls-heart" d="M63,8.94c1.72,.76,3.33,1.88,4.73,3.36,6.6,6.99,3.87,15.62-1.58,23.33"/>
  </g>
</svg>`;
  machine: string = `<svg id="" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23.01 42" width="5rem" height="4rem">
<defs>
  <style>
    .cls-machine {
...
<g id="CONTENT">
  <g>
    <path class="cls-machine" d="M14.86,32.29H6.06c-.2,0-.39-.08-.52-.23C1.97,28.24,0,23.26,0,18.03V5.81c0-.39,.32-.71,.71-.71H11.63c.39,0,.71,.32,.71,.71s-.32,.71-.71,.71H1.43v11.5c0,4.76,1.76,9.31,4.95,12.83H14.55c3.19-3.52,4.95-8.06,4.95-12.83v-.8c0-.39,.32-.71,.71-.71s.71,.32,.71,.71v.8c0,5.23-1.97,10.21-5.54,14.03-.13,.14-.32,.23-.52,.23Z"/>
    <path class="cls-machine" d="M10.46,42c-1.52,0-2.76-1.24-2.76-2.76v-7.67c0-.39,.32-.71,.71-.71h4.1c.39,0,.71,.32,.71,.71v7.67c0,1.52-1.24,2.76-2.76,2.76Zm-1.33-9.71v6.95c0,.74,.6,1.33,1.33,1.33s1.33-.6,1.33-1.33v-6.95h-2.67Z"/>
    <path class="cls-machine" d="M13.68,17.61H.71c-.39,0-.71-.32-.71-.71v-7.65c0-.39,.32-.71,.71-.71H10.46c.39,0,.71,.32,.71,.71s-.32,.71-.71,.71H1.43v6.22H13.68c.39,0,.71,.32,.71,.71s-.32,.71-.71,.71Z"/>
    <path class="cls-machine" d="M17.64,15.89c-2.96,0-5.37-2.41-5.37-5.37C12.49,5.47,16.92,.44,17.11,.23c.27-.3,.8-.3,1.07,0,.19,.21,4.62,5.24,4.83,10.26,0,2.99-2.41,5.4-5.37,5.4Zm0-14.06c-1.15,1.47-3.79,5.19-3.94,8.72,0,2.14,1.77,3.91,3.94,3.91s3.94-1.77,3.94-3.94c-.15-3.51-2.79-7.23-3.94-8.69Z"/>
    <path class="cls-machine" d="M2.78,6.53c-.39,0-.71-.32-.71-.71,0-1.97,1.6-3.58,3.58-3.58h6.73c.39,0,.71,.32,.71,.71s-.32,.71-.71,.71H5.65c-1.19,0-2.15,.96-2.15,2.15,0,.39-.32,.71-.71,.71Z"/>
    <path class="cls-machine" d="M16.25,20.68H4.68c-.39,0-.71-.32-.71-.71s.32-.71,.71-.71h11.57c.39,0,.71,.32,.71,.71s-.32,.71-.71,.71Z"/>
    <path class="cls-machine" d="M10.46,29.5c-2.17,0-3.93-1.76-3.93-3.93s1.76-3.93,3.93-3.93,3.93,1.76,3.93,3.93-1.76,3.93-3.93,3.93Zm0-6.44c-1.38,0-2.51,1.12-2.51,2.51s1.12,2.51,2.51,2.51,2.51-1.12,2.51-2.51-1.12-2.51-2.51-2.51Z"/>
    <path class="cls-machine" d="M8.11,13.78h-2.59c-.39,0-.71-.32-.71-.71s.32-.71,.71-.71h2.59c.39,0,.71,.32,.71,.71s-.32,.71-.71,.71Z"/>
    <path class="cls-machine" d="M6.81,15.08c-.39,0-.71-.32-.71-.71v-2.59c0-.39,.32-.71,.71-.71s.71,.32,.71,.71v2.59c0,.39-.32,.71-.71,.71Z"/>
  </g>
</g>
</svg>`;
  thermo1: string = `<svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 161 26.26">
<defs>
  <style>
    .cls-thermo1 {
      fill: none;
...
<g id="CONTENT">
  <g>
    <rect class="cls-thermo1" x="104.56" y="-20.55" width="25.26" height="67.37" rx="2.41" ry="2.41" transform="translate(104.06 130.32) rotate(-90)"/>
    <path class="cls-thermo1" d="M146.06,8.32h19.25v4.81c0,2.66-2.16,4.81-4.81,4.81h-9.62c-2.66,0-4.81-2.16-4.81-4.81v-4.81h0Z" transform="translate(142.56 168.82) rotate(-90)"/>
    <path class="cls-thermo1" d="M19.15,10.12h7.22c1.99,0,3.61,1.62,3.61,3.61v2.41H15.54v-2.41c0-1.99,1.62-3.61,3.61-3.61Z" transform="translate(9.62 35.89) rotate(-90)"/>
    <rect class="cls-thermo1" x="105.46" y="7.12" width="19.25" height="12.03" rx="2.41" ry="2.41"/>
    <g>
      <line class="cls-thermo1" x1="150.88" y1="6.82" x2="146.06" y2="6.82"/>
      <line class="cls-thermo1" x1="150.88" y1="13.13" x2="146.06" y2="13.13"/>
      <line class="cls-thermo1" x1="150.88" y1="19.45" x2="146.06" y2="19.45"/>
    </g>
    <path class="cls-thermo1" d="M83.51,3.46H28.17c-1.33,0-2.41,1.08-2.41,2.41v14.44c0,1.33,1.08,2.41,2.41,2.41h55.34V3.46Zm-48.12,15.04c-1.99,0-3.61-1.62-3.61-3.61v-3.61c0-1.99,1.62-3.61,3.61-3.61h42.71v10.83H35.39Z"/>
    <path class="cls-thermo1" d="M9.11,3.51h2.03c.77,0,1.39,.62,1.39,1.39V22.76H7.72V4.9c0-.77,.62-1.39,1.39-1.39Z" transform="translate(-3.01 23.26) rotate(-90)"/>
  </g>
</g>
</svg>`;
  thermo2: string = `<svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 161 26.26">
  <defs>
    <style>
      .cls-1 {
        fill: #fff;
