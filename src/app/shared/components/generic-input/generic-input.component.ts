...
export class GenericInputComponent implements OnInit {
  ...
  @Input() inputDisabledClasses: string = ' bef ';
  @Input() labelClasses: string = ' bef ';
  @Input() buttonClasses: string = ' bef ';
  @Input() listClasses: string = '';
  @Input() disabledClassButton: string = ' bef ';
  @Input() readonlyClassButton: string = ' bef ';
  @Input() containerClasses: string = ' d-flex align-items-center ';
